...
fileprivate struct TestFixtures {
    ...
    static let authenticationUseCaseForSuccess = MockAuthenticationUseCase(shouldSignInSuccess: true, signInReturn: mockAuthUser)
    static let authenticationUseCaseForFailure = MockAuthenticationUseCase(shouldSignInSuccess: false)
    static let fetchAuthenticatedUserUseCaseWithExistingUser = MockFetchAuthenticatedUserUseCase(excuteReturn: mockAuthUser)
    static let fetchAuthenticatedUserUseCaseWithoutExistingUser = MockFetchAuthenticatedUserUseCase(excuteReturn: nil)
}
...
struct AuthManagerTests {
    ...
    struct SignInTests {
        ...
        let fetchAuthenticatedUserUseCase = TestFixtures.fetchAuthenticatedUserUseCaseWithoutExistingUser
    ...
    struct fetchAUserTests {
        ...
        func fetchAUserWithExistingUser() {
            ...
            let authManager = AuthManager(authenticationUseCase: authenticationUseCase, fetchAuthenticatedUserUseCase: fetchAuthenticatedUserUseCase)
