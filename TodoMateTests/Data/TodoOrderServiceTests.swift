...
struct TodoOrderServiceTests {
  ...
  struct LoadOrderTests {
    ...
    func loadOrderSucceedsWithSameDate() {
      // Given
      let service = TodoOrderService(todoOrderRepository: TestFixtures
        .todoOrderRepositoryForLoadSuccess())
    ...
    func loadOrderFailsWithNoSavedDate() {
      // Given
      let service = TodoOrderService(todoOrderRepository: TestFixtures
        .todoOrderRepositoryForLoadFailureNoDate())
    ...
    func loadOrderFailsWithDifferentDate() {
      // Given
      let service = TodoOrderService(todoOrderRepository: TestFixtures
        .todoOrderRepositoryForLoadFailureDifferentDate())
