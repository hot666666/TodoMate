...
After the PR is opened, follow the review follow-up workflow to incorporate comments (or proceed when there are no comments yet):

- `.agent/workflows/github-pr-review-followup-workflow.md`

## 3. Squash Merge

After review approval, perform a **Squash Merge** to maintain a clean commit history.

### Squash Commit Message Guidelines

Before merging, prepare a proper squash commit message:
