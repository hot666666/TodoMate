...
After create Issue, return gh issue url.
...
If the repository has a suitable template, use it. If not, or if a better template is needed, refer to the template below and create a new one:

### Recommended Issue Template
```md
---
name: Work Issue
about: Issue for new features, improvements, refactoring, etc.
title: ''
labels: ''
assignees: ''
---
...
## Background & Goal
<!-- Explain why this work is needed and what you want to achieve -->

## Work Description
<!-- Describe specifically what work will be performed -->

## Acceptance Criteria
<!-- Write clear criteria as a checklist to determine when this work is complete -->
- [ ]
- [ ]
- [ ]

## Test Plan
<!-- Briefly describe how to verify this work -->

## Notes
<!-- Add any additional information such as related issues, documentation, screenshots, etc. -->

## Work Items (if needed)
<!-- If this work needs to be divided into multiple steps, write them here -->
- [ ]
- [ ]
```
...
- Write a clear and specific title with a prefix (without brackets), such as: `Feat: Implement user profile edit feature`, `Fix: Improve API response speed`, `Refactor: Login page UI`
...
gh issue create --title "Feat: Implement user profile edit feature" --body "..."
```
