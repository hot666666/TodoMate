...
extension Calendar {
  ...
  // func isDate(_ date1: Date, inSameDayAs date2: Date) -> Bool
  // func isDate(_ date: Date, equalTo otherDate: Date, toGranularity component: Calendar.Component)
  // -> Bool
  ...
  func getTodayDateRange() -> (start: Date, end: Date) {
    ...
    let endOfDay = date(byAdding: .day, value: 1, to: startOfDay)!.addingTimeInterval(-1)
