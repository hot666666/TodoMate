...
extension Color {
  ...
  static let customDarkRed = Color(red: 0xD3 / 255, green: 0x2F / 255, blue: 0x2F / 255)
  static let customBlack = Color(red: 0x17 / 255, green: 0x17 / 255, blue: 0x17 / 255)
  static let customDarkBg = Color(red: 0x21 / 255, green: 0x21 / 255, blue: 0x21 / 255)
  static let customLightDark = Color(red: 0x30 / 255, green: 0x30 / 255, blue: 0x30 / 255)
}
