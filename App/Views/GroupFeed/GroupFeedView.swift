...
// MARK: - Group Member Section (Simplified, no glass card)
...
private struct ChatPanelView: View {
  ...
  private var chatInput: some View {
    VStack(spacing: 0) {
      ...
      HStack(spacing: 8) {
        // Photo picker (plain style, no glass)
        ...
        // Send button (sized to match input height ~32pt)
        Button {
